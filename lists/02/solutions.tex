...
\begin{enumerate}[\bfseries  1.]
  ...
  \item Dados os vetores $\vec u = (4,\alpha, -1)$ e
    ...
    $$
    (4,\alpha,-1)\cdot ((4,-1,2)+((4,-1,2)-(3,2,-1)))=5
    $$
    $$
    (4,\alpha,-1)\cdot ((4,-1,2)+(1,-3,3))=5
    $$
    $$
    (4,\alpha,-1)\cdot (5,-4,5)=5
    $$
    $$
    4\cdot 5 + \alpha\cdot (-4) + -1\cdot 5=5
    $$
    $$
    20 -4\alpha -5=5
    $$
    $$
    -4\alpha=5-15\implies \alpha=\frac{-10}{-4}=\frac{5}{2}
    $$
