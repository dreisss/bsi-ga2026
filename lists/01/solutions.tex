...
\begin{enumerate}[\bfseries  1.]
  ...
  \item
    ...
    $$
    $$
    II - I \Rightarrow 4 = a_2 - 3a_3\\
    $$
    $$
    \text{Sub-sistema:}\\
    $$
    $$
    \begin{cases} a_2 - a_3 = 2 \\ a_2 - 3a_3 = 4
    \end{cases}\\
    $$
    $$
    2a_3 = -2 \Rightarrow a_3 = -1\\
    $$
    $$
    \Rightarrow a_2 =
    \begin{cases}1\\7
    ...
    $$
    $$
    \text{Não existe solução -> Resposta errada!!!! - Errei no
    cálculo de cabeça}
    $$
